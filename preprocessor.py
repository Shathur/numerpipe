...
class Preprocessor:
    ...
    def download_data(
        ...
        if features:
            self.napi.download_dataset(
                "v4.3/features.json", os.path.join(self.datapath, "features.json")
            )
        if meta_model:
            self.napi.download_dataset(
